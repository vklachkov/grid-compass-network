...
use super::protocol::{
    ...
    VFS_ERROR_BAD_PARAMETER, VFS_ERROR_DEVICE_FULL, VFS_ERROR_FILE_EXISTS,
    VFS_ERROR_FILE_NOT_FOUND, VFS_ERROR_FILE_NOT_OPEN, VFS_ERROR_NOT_SUPPORTED,
    VFS_ERROR_RESOURCE_UNAVAILABLE, VFS_ERROR_WRITE_PROTECTED,
};
...
pub(super) fn error_code(error: &Error) -> u16 {
    match error {
        ...
        Error::FileNotFound => VFS_ERROR_FILE_NOT_FOUND,
        Error::WriteProtected => VFS_ERROR_WRITE_PROTECTED,
